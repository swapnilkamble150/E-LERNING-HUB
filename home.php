...
-->
      <div class="box tutor">
         ...
         <p>My motivation to embark on a career in tutoring stems from a deep-rooted passion for education and the transformative power it holds.</p>
...
<section class="courses">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="ind.php" class="inline-btn">Start Quiz</a>
      </div>
      <?php
         }
      }else{
...
<script>
  window.botpressWebChat.init({
      ...
      "botConversationDescription": "This bot is built by Polytechnic students",
